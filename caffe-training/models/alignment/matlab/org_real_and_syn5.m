...
synDir ='/home/ljyang/work/alignment/3d_models/car_models/obj_merge3/';
savDir ='/home/ljyang/work/data/real_and_syn5/';
train_filename = ['../lists/transfer_train_fg'];
...
for i=1:len
    if model_3d_info(i).is_test==0 %for train
        ...
        param_3d = model_3d_info(i).shape_param_ds;
