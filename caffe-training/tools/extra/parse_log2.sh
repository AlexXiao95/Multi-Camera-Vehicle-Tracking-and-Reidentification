...
grep 'Test net output #2' aux.txt | awk '{print $11}' > aux5.txt
...
# Generating
echo '#Iters Seconds Accuracy Accuracy_top-5 TestLoss'> $LOG.test
paste aux0.txt aux4.txt aux1.txt aux2.txt aux5.txt | column -t >> $LOG.test
