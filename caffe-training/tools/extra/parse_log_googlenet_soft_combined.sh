...
grep 'Test net output #10:' aux.txt | awk '{print $11}' > aux1.txt # top1 of loss3
grep 'Test net output #0:' aux.txt | awk '{print $15}' > aux2.txt # loss1 (weighted)
grep 'Test net output #4:' aux.txt | awk '{print $15}' > aux5.txt # loss2 (weighted)
grep 'Test net output #8:' aux.txt | awk '{print $15}' > aux6.txt # loss3 (weighted)
grep 'Test net output #11:' aux.txt | awk '{print $11}' > top5.txt # top5 of loss3
