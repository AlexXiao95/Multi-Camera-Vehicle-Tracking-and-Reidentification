...
Layer<Dtype>* GetLayer(const LayerParameter& param) {
  ...
  case LayerParameter_LayerType_EXT_LABEL_ACCURACY:
    return new ExtLabelAccuracyLayer<Dtype>(param);
  ...
  case LayerParameter_LayerType_WEIGHTED_EUCLIDEAN_LOSS:
    return new WeightedEuclideanLossLayer<Dtype>(param);
  ...
  case LayerParameter_LayerType_SOFT_LOGISTIC_LOSS:
    return new SoftLogisticLossLayer<Dtype>(param);
  ...
  case LayerParameter_LayerType_SOFTMAX_LOSS_WITH_INVALID:
    return new SoftmaxLossWithInvalidLayer<Dtype>(param);
