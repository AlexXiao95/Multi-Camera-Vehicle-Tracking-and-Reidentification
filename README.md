...
### Input/Output Format
Simply run ``bash run_all.sh`` in the command line. The input is single camera tracking results for all 15 videos by using our method in Track 1. The format of each line is as follows:
